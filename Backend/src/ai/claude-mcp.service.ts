...
2. brand, models, gm_number, price, description ИЗВЛЕКАЙ из текста, не меняя сам title.
...
8. Игнорируй телефонные номера, эмодзи и лишний текст ПРИ ИЗВЛЕЧЕНИИ полей (но не переписывай из-за них title).
