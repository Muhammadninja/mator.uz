...
export const VEHICLE_CATALOG: CatalogBrand[] = [
  ...
  },
  {
    ...
    aliases: ['mitsubishi', 'мицубиси', 'митсубиси', 'митсу'],
    models: [
      { canonical: 'Lancer', aliases: ['lancer', 'лансер'] },
      { canonical: 'Outlander', aliases: ['outlander', 'аутлендер'] },
      { canonical: 'ASX', aliases: ['asx', 'асх'] },
      { canonical: 'Pajero Sport', aliases: ['pajero sport', 'паджеро спорт'] },
      { canonical: 'Pajero', aliases: ['pajero', 'паджеро', 'монтеро'] },
      { canonical: 'Montero', aliases: ['montero', 'монтеро'] },
      { canonical: 'L200', aliases: ['l200', 'л200'] },
      { canonical: 'Eclipse Cross', aliases: ['eclipse cross', 'эклипс кросс'] },
      { canonical: 'Xpander', aliases: ['xpander', 'икспандер'] },
    ],
  },
  {
    canonical: 'Acura',
    aliases: ['acura', 'акура'],
    models: [
      { canonical: 'MDX', aliases: ['mdx', 'мдх'] },
      { canonical: 'RDX', aliases: ['rdx', 'рдх'] },
      { canonical: 'TLX', aliases: ['tlx'] },
      { canonical: 'ILX', aliases: ['ilx'] },
      { canonical: 'ZDX', aliases: ['zdx'] },
      { canonical: 'RSX', aliases: ['rsx'] },
      { canonical: 'TSX', aliases: ['tsx'] },
    ],
  },
  {
    canonical: 'Infiniti',
    aliases: ['infiniti', 'инфинити', 'infinity'],
    models: [
      { canonical: 'Q50', aliases: ['q50'] },
      { canonical: 'Q60', aliases: ['q60'] },
      { canonical: 'Q70', aliases: ['q70'] },
      { canonical: 'QX50', aliases: ['qx50'] },
      { canonical: 'QX55', aliases: ['qx55'] },
      { canonical: 'QX60', aliases: ['qx60'] },
      { canonical: 'QX70', aliases: ['qx70'] },
      { canonical: 'QX80', aliases: ['qx80'] },
      { canonical: 'FX35', aliases: ['fx35', 'фх35'] },
      { canonical: 'FX37', aliases: ['fx37', 'фх37'] },
      { canonical: 'FX45', aliases: ['fx45', 'фх45'] },
    ],
  },
  {
    canonical: 'Subaru',
    ...
    models: [
      { canonical: 'Impreza', aliases: ['impreza', 'импреза'] },
      { canonical: 'Legacy', aliases: ['legacy', 'легаси'] },
      { canonical: 'Outback', aliases: ['outback', 'аутбек'] },
      { canonical: 'Forester', aliases: ['forester', 'форестер'] },
      { canonical: 'XV', aliases: ['subaru xv', 'иксв'] },
      { canonical: 'Crosstrek', aliases: ['crosstrek', 'кросстрек'] },
      { canonical: 'Ascent', aliases: ['ascent', 'асцент'] },
      { canonical: 'WRX', aliases: ['wrx', 'врх'] },
      { canonical: 'BRZ', aliases: ['brz', 'брз'] },
    ],
  },
  {
    canonical: 'Suzuki',
    aliases: ['suzuki', 'сузуки', 'судзуки'],
    models: [
      { canonical: 'Swift', aliases: ['swift', 'свифт'] },
      { canonical: 'Baleno', aliases: ['baleno', 'балено'] },
      { canonical: 'Vitara', aliases: ['vitara', 'витара'] },
      { canonical: 'Grand Vitara', aliases: ['grand vitara', 'гранд витара'] },
      { canonical: 'Jimny', aliases: ['jimny', 'джимни'] },
      { canonical: 'SX4', aliases: ['sx4', 'схч'] },
      { canonical: 'Celerio', aliases: ['celerio', 'селерио'] },
      { canonical: 'Ertiga', aliases: ['ertiga', 'эртига'] },
      { canonical: 'S-Presso', aliases: ['s-presso', 'spresso', 'эспрессо'] },
    ],
  },
  {
    canonical: 'Daihatsu',
    aliases: ['daihatsu', 'дайхатсу', 'дайхацу'],
    models: [
      { canonical: 'Terios', aliases: ['terios', 'териос'] },
      { canonical: 'Sirion', aliases: ['sirion', 'сирион'] },
      { canonical: 'Materia', aliases: ['materia', 'материя'] },
      { canonical: 'Rocky', aliases: ['rocky', 'роки'] },
      { canonical: 'Gran Max', aliases: ['gran max', 'гран макс'] },
    ],
  },
  {
    canonical: 'Isuzu',
    aliases: ['isuzu', 'исузу', 'исудзу'],
    models: [
      { canonical: 'D-Max', aliases: ['d-max', 'dmax', 'д-макс'] },
      { canonical: 'MU-X', aliases: ['mu-x', 'mux', 'му-х'] },
      { canonical: 'Trooper', aliases: ['trooper', 'трупер'] },
      { canonical: 'NPR', aliases: ['npr', 'нпр'] },
      { canonical: 'Elf', aliases: ['isuzu elf', 'эльф'] },
    ],
  },
  {
    canonical: 'Nissan',
