...
export const VEHICLE_CATALOG: CatalogBrand[] = [
  {
    canonical: 'Chevrolet',
    aliases: ['chevrolet', 'chevy', 'шевроле', 'шеврале', 'chevrolet uz'],
    models: [
      { canonical: 'Cobalt', aliases: ['cobalt', 'кобальт', 'koblt', 'cobolt', 'kobalt', 'кобалт'] },
      { canonical: 'Gentra', aliases: ['gentra', 'джентра', 'жентра', 'gentr', 'gentar'] },
      { canonical: 'Spark', aliases: ['spark', 'спарк', 'spark', 'спар'] },
      { canonical: 'Nexia 3', aliases: ['nexia 3', 'nexia3', 'нексия 3', 'нексия3', 'некся 3'] },
      { canonical: 'Nexia', aliases: ['nexia', 'нексия', 'некся', 'nexya'] },
  ...
  },
  {
    ...
    models: [
      { canonical: 'Nexia', aliases: ['nexia', 'нексия'] },
  ...
  },
  {
    ...
    aliases: ['ravon', 'равон'],
    models: [
      { canonical: 'R2', aliases: ['r2', 'р2', 'spark', 'спарк'] },
      { canonical: 'R3', aliases: ['r3', 'р3', 'nexia r3', 'нексия r3'] },
      { canonical: 'R4', aliases: ['r4', 'р4', 'cobalt', 'кобальт'] },
      { canonical: 'Gentra', aliases: ['gentra', 'джентра'] },
      { canonical: 'Matiz', aliases: ['matiz', 'матиз'] },
    ],
  },
  {
