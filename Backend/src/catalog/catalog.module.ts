...
@Module({
  ...
  providers: [PartsService, SearchService, TopFeaturedService, CategoriesService, CatalogProjectionService],
  controllers: [PartsController, SearchController, TopFeaturedController, CategoriesController],
