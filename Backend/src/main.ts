...
async function bootstrap() {
  ...
  // route/DTO map isn't published to the internet. It can be re-enabled in
  // production deliberately (e.g. behind proxy auth) with ENABLE_SWAGGER=true.
  ...
  if (swaggerEnabled) {
    ...
    logger.log('Swagger docs disabled in production (set ENABLE_SWAGGER=true to enable).');
  }
