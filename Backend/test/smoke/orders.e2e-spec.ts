...
import { createPrismaMock, fakeConfig, buildCart, buildCartItem, buildOrder, buildAppUser, PrismaMock } from '../utils/harness';
...
describe('Orders smoke', () => {
  ...
  it('creates an order from the cart with correct totals and consumes the cart', async () => {
    const svc = new OrdersService(prisma, fakeConfig());
